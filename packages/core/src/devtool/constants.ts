...
export const DEVTOOL_ICON_ID = `${DEVTOOL_ID}-handle`;
export const DEVTOOL_INFO_ID = `${DEVTOOL_ID}-info`;
export const DEVTOOL_SOCKET_ICON = `${DEVTOOL_ICON_ID}-socket`;
export const DEVTOOL_CLOSE_ICON = `${DEVTOOL_ICON_ID}-close`;
...
export const LogTypeColors: Record<
  (typeof LogTypes)[keyof typeof LogTypes],
  (typeof Colors)[keyof typeof Colors]
> = {
  SUCCESSFUL_RECONNECTION: Colors.GREEN,
  SUBSCRIBED: Colors.GREEN,
  RECONNECTION_FAILURE: Colors.RED,
  RECONNECTING: Colors.YELLOW,
  CONNECTION_ERROR: Colors.RED,
  RECONNECTING_ERROR: Colors.RED,
...
<svg id="${DEVTOOL_SOCKET_ICON}" width="1rem" height="1rem" viewBox="0 -31.5 256 256" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
...
<svg id="${DEVTOOL_CLOSE_ICON}" width="1rem" height="1rem" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
